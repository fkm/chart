...
export default class Chart extends EventEmitter {
	constructor(config) {
		...
		this.datasets = new Datasets(this, config.datasets);
		...
		this.setDatasets = this.datasets.setDatasets;
		this.setSources = this.sources.setSources;
	...
	destroy() {
		...
		delete this.setDatasets;
		delete this.setSources;
	}
}
